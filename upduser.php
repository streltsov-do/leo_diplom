...
/*
1.Подключение к БД 
2.Обработка добавления пользователя (step=2)
3.HTML-шаблон с подключением CSS и библиотек
4.Верхний хедер с контактами и информацией о пользователе
5.Основной хедер с логотипом и меню навигации
6.Навигационное меню с активным пунктом "Пользователи"
7.Форма добавления пользователя
8.Футер с иконками платёжных систем
9.Подключение JS-скриптов
*/
