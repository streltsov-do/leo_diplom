<?
/*
1. Подключение к БД (option.php)
2. HTML-шаблон с подключением CSS и библиотек
3. Верхний хедер с контактами и отображением текущего пользователя
4. Основной хедер с лого, поиском и меню навигации
5. Логика фильтрации пользователей по ФИО
6. Форма управления с кнопками фильтра, добавления, удаления
7. Вывод таблицы с пользователями (ФИО, почта, логин, пароль, права)
8. Футер с иконками платёжных систем и копирайтом
9. Подключение JS-скриптов (jQuery, Bootstrap и другие библиотеки)
*/
