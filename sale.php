...
5.Получение параметра step
6.Обработка смены статуса заказа
7.Формирование SQL с фильтрацией и сортировкой
8.Элементы сортировки и фильтрации
9.Кнопки управления заказами
10.Таблица списка заказов
11.Футер и скрипты
*/
