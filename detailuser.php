...
7.Запрос деталей заказа из БД
8.Отображение заголовка с номером заказа
9.Таблица с деталями заказа: товар, категория, цена, количество
10.Ссылки на страницы товаров (annotation.php)
11.Кнопка "Назад"
12. Футер
...
<br>
<input  type="button"  name="button" <? if (mysqli_num_rows($r)==0) {?>    disabled="disabled"<? }?>  onclick="history.back(1);" value="Назад">   
