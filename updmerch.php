<?
/*
1.Обработка разных шагов (step=1, 2, 3): управление файлами и куками
2.Подключение к БД
3.Обработка step=2: добавление товара в БД
4.Обработка step=3: загрузка файла изображения
5.HTML-шаблон с подключением CSS
6.Верхний хедер с контактами
7.Основной хедер с лого и поиском
8.Навигационное меню для администратора
9.Форма добавления товара с полями: картинка, название, категория, цена, описание
10.Загрузка файлов изображений
11.Выпадающий список с категориями из БД
12.Кнопки управления: Загрузить, OK, Отмена
13.Футер
14.Подключение JS-скриптов
*/
$step=$_REQUEST["step"];
if ($step==1)
{
...
$file="";
  ...
  {//формирование SQL-запроса на добавление данных
	 mysqli_query($dbcnx,"INSERT INTO merch (merch, idcategory, price, file, annotation) VALUES ('$merch', $category, '$price',  '$file', '$annotation')");
...
<form name="form2" method="post"  enctype="multipart/form-data" >
				  <table width="622" border="0">
                    <tr >
                      <td><font color="#000000" >Картинка:  </font></td>
                      <td> 
							<table>
                            <tr>
						<td>
                       ...
                       <td>
                      <input type="button"  name="button"  value="Загрузить" onClick="this.form.action='updmerch.php?step=3'; this.form.submit();">
                      </td>
                      </tr>
                      	</table>
                      </td>
...
<tr> 
 <td><font color="#000000" >   Категория: </font></td>
        ...
        <select name="category"  style="height:22; width:auto" >
  <?
...
?>
                    ...
                    <tr>
                      ...
                      <td><input   name="price"  value="<? if ($upd==1) echo "$f[price]"; else echo(""); ?>"   type="number" ></td>
                    </tr>  			  
