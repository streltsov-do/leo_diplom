<?
/*
1.Подключение файла настроек БД
2.Получение параметра step из запроса
3.Обработка step=2: регистрация пользователя
4.Получение данных формы: ФИО, почта, логин, пароль
5.Валидация логина (длина)
6.Добавление пользователя в БД с ролью "Покупатель"
7.Редирект на главную страницу с сообщением об успехе
8.HTML-шаблон с подключением CSS
9.Верхний хедер с контактами
10.Основной хедер с лого и поиском
11.Навигационное меню: Главная, Регистрация
12.Форма регистрации с полями: ФИО, почта, логин, пароль
13.Кнопки: OK (отправка формы), Отмена (возврат назад)
14.Футер
15.Подключение JS-скриптов
*/
...
<form name="form2" method="post"  >
				  <table width="422" border="0">
                    <tr>
                      ...
                      <td><input   name="fio"   type="text"  value="" size="40" ></td>
                    </tr>  	          
                    <tr>
                    ...
                    <tr>
                      ...
                      <td><input   name="parol"  value=""   type="text" ></td>
                    </tr>      
