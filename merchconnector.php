<?
/*
1.Подключение к БД и сохранение ID товара в куки
2.HTML-шаблон с подключением CSS
3.Верхний хедер с контактами
4.Основной хедер с лого и поиском
5.Навигационное меню для администратора
6.Получение названия товара из БД
7.Заголовок "Разъемы товара"
8.Запрос всех разъемов и их связи с товаром
9.Обработка step=1: сохранение выбранных разъемов
10.Обработка step=2: очистка всех разъемов товара
11.Таблица с чекбоксами для выбора разъемов
12.Кнопки управления: Сохранить, Очистить
13.Футер
